    ...
    , roleManager(nullptr)
{
    ...
    // 设置占位符文本
    ui->messageEdit->setPlaceholderText("请您输入消息...");
    
    // 显示欢迎消息
    ui->chatDisplay->append("<div style='color: #666; font-style: italic;'>欢迎使用麒麟多功能智能助手，请输入您的问题...</div>");
}
...
void ChatWindow::setCurrentRole(const QString &role)
{
    ...
    // 显示欢迎消息
    QString welcomeMessage = QString("<div style='background-color:rgb(108, 238, 162); padding: 10px; border-radius: 5px; margin-bottom: 10px;'>"
                                     "<span style='font-weight: bold; color:rgb(71, 100, 38);'>目前角色为：%1</span><br><br>"
                                     "%2</div>")
        .arg(role)
        .arg("您好！我是您的麒麟多功能智能助手，请问有什么可以帮您？");
...
void ChatWindow::onRoleSelected(const QString &roleName)
{
    ...
    ui->chatDisplay->clear();
    // 显示欢迎消息
    QString welcomeMessage = QString("目前角色为：%1\n\n%2")
        .arg(roleName)
        .arg("您好！我是您的麒麟多功能智能助手，请问有什么可以帮您？");
    ui->chatDisplay->append(welcomeMessage);
}
